...
public class AAEstadoCivilDTO {
    ...
    public AAEstadoCivilDTO(Integer AAidCatalogo, Integer AAidCatalogoTipo, String AAnombre, String AAdescripcion, String AAestado,
    ...
    public void setAAAidCatalogo(Integer AAidCatalogo) {
        this.AAidCatalogo = AAidCatalogo;
    }
